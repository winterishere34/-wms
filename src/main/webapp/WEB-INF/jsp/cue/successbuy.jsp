...
<body>
	<div class="wrap">
		<div class="logo">
			<h1>恭喜您，已完成填写</h1>
			<p>您的进货单，明细单号为${bodId}已完成填写</p>
			<p>您可以点击一下按钮选择返回查看</p>
			<form class="navbar-form navbar-center" role="search"
				action="${APP_PATH}/buyOrderDetail/OneDetaillist" method="post">
				<div class="form-group">
					<input type="text" name="search" value="${bodId}" class="form-control" readonly="readonly">
				</div>
